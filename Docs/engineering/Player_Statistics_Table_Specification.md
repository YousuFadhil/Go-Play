...
| `PS-D3` | **Is `DP-8` one principle or two?** It is named *Historical Record Protection* here and *Historical Independence* in the previous brief | **Confirm.** §13 addresses the formulation stated here and the reading covers both; if they are distinct, one has not been validated against |
